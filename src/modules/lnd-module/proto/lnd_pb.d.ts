...
export namespace SendRequest {
  export type AsObject = {
    ...
    amt: number,
    amt_msat: number,
    payment_hash: Uint8Array | string,
    payment_hash_string: string,
    payment_request: string,
    final_cltv_delta: number,
    fee_limit?: FeeLimit.AsObject,
    outgoing_chan_id: string,
    last_hop_pubkey: Uint8Array | string,
    cltv_limit: number,
    dest_custom_records_map: Array<[number, Uint8Array | string]>,
    allow_self_payment: boolean,
    dest_features_list: Array<FeatureBitMap[keyof FeatureBitMap]>,
...
export namespace SendResponse {
  export type AsObject = {
    ...
    payment_preimage: Uint8Array | string,
    payment_route?: Route.AsObject,
    payment_hash: Uint8Array | string,
  }
}
...
export namespace ListUnspentResponse {
  export type AsObject = {
    utxos_list: Array<Utxo.AsObject>,
  }
}
...
export namespace Channel {
  export type AsObject = {
    ...
    num_updates: number,
    pending_htlcs_list: Array<HTLC.AsObject>,
    csv_delay: number,
    pb_private: boolean,
    initiator: boolean,
    ...
    commitment_type: CommitmentTypeMap[keyof CommitmentTypeMap],
    lifetime: number,
    uptime: number,
    close_address: string,
    push_amount_sat: number,
    thaw_height: number,
    local_constraints?: ChannelConstraints.AsObject,
    remote_constraints?: ChannelConstraints.AsObject,
  }
}
...
export namespace ListChannelsResponse {
  export type AsObject = {
    channels_list: Array<Channel.AsObject>,
  }
}
...
export namespace GetInfoResponse {
  export type AsObject = {
    ...
    testnet: boolean,
    chains_list: Array<Chain.AsObject>,
    uris_list: Array<string>,
    features_map: Array<[number, Feature.AsObject]>,
  }
}
...
export namespace ChannelOpenUpdate {
  export type AsObject = {
    channel_point?: ChannelPoint.AsObject,
  }
}
