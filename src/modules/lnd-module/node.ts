...
export const GetTransactions = function () {
	return new Promise<TransactionDetails.AsObject | null>(
		(resolve, reject) => {
...
export const WalletBalance = function () {
	return new Promise<WalletBalanceResponse.AsObject | null>(
		(resolve, reject) => {
...
export const GetInfo = function () {
	return new Promise<GetInfoResponse.AsObject | null>(
		(resolve, reject) => {
...
export const NewAddress = function () {
	return new Promise<NewAddressResponse.AsObject | null>(
		(resolve, reject) => {
...
export const ListInvoices = function () {
	return new Promise<ListInvoiceResponse.AsObject | null>(
		(resolve, reject) => {
...
export const SendCoins = function (address: string, amount: number) {
	...
	return new Promise<SendCoinsResponse.AsObject | null>(
		(resolve, reject) => {
...
export const SendPayment = function ({ payment_request }) {
	...
	return new Promise<SendResponse.AsObject | null>(
		(resolve, reject) => {
...
export const ListPayments = function () {
	return new Promise<ListPaymentsResponse.AsObject | null>(
		(resolve, reject) => {
...
export const AddInvoice = function (description, value) {
	return new Promise<AddInvoiceResponse.AsObject | null>(
		(resolve, reject) => {
			const parameters = {
...
export const SendMany = function (addrToAmountEntries) {
	...
	return new Promise<SendManyResponse.AsObject | null>(
		(resolve, reject) => {
