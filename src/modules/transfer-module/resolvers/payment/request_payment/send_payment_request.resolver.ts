...
export const ApiSendRequestPaymentResponse = ApiResponse<TransactionRequest>(
  "SendPaymentRequest",
  TransactionRequest
);
...
class SendPaymentRequestResolver {
  ...
  async sendPaymentRequest(
    @Arg("data")
    { amount, currency, walletId, method, description }: SendRequestPaymentDto,
    @Ctx()
    ...
    mqProduce<"transaction_requested">(channel, Queue.NOTIFICATION_QUEUE, {
      data: {
        transactionRequest,
      },
